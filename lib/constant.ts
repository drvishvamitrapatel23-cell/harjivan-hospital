...
export const SERVICES = [
  ...
  },
  {
    ...
    slug: "eecp-therapy",
    desc: "Non-invasive cardiac therapy - the natural bypass.",
  },
  {
    icon: Droplets,
    title: "Padabhyanga (Foot Therapy)",
    slug: "padabhyanga",
    desc: "Traditional Ayurvedic medicated foot massage.",
  },
  {
    icon: Heart,
    title: "Heart Reversal Programme",
    slug: "heart-reversal",
    desc: "Halt and reverse coronary artery disease naturally.",
  },
  {
    icon: Sun,
    title: "Skin Care Treatment",
    slug: "skin-care",
    desc: "Root-cause Ayurvedic treatment for all skin diseases.",
  },
  {
    icon: Scissors,
    title: "Hair Removal Treatment",
    slug: "hair-removal",
    desc: "Safe, medically supervised laser hair removal.",
  },
  {
    icon: Candy,
    title: "Diabetes Management",
    slug: "diabetes-management",
    desc: "Integrative programme to control and reverse diabetes.",
  },
  {
    icon: FlowerIcon,
